...
![Self Build OTA](../images/sec_xschem/self_build_ota.png){#fig-self_build_ota width=80% fig-alt="Self-built OTA schematic in Xschem"}
...
Use these details directly sourced from your professor’s transcript as you write each section. This ensures your report is tightly aligned with your professor’s specific instructions and recommendations.
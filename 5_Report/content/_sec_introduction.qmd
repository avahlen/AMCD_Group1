...
- scope of this project in AMCD:
	- characterisation biquad filter with specification
	- behauviroal analysis of biqaud (mathematical description as second order functions)
	- circuit of biquad filters
	- usage of own opamps:
		- design of opamp to usage in biquad filter
		- best case scenario is tap out of ic, but realistic is a simulated LVS schem (with personalized version of given opamp circuit by pretl)

makes no sense to write this now, only produce garbage
